...
def detect_choice(option_cards):
    ...
    while not pygame_functions.keyPressed('esc'):
        if pygame_functions.sprite_clicked(option_cards[TYPES_ENUM['rock']].card_sprite):
            return make_choice(option_cards[TYPES_ENUM['rock']])

        elif pygame_functions.sprite_clicked(option_cards[TYPES_ENUM['paper']].card_sprite):
            return make_choice(option_cards[TYPES_ENUM['paper']])

        elif pygame_functions.sprite_clicked(option_cards[TYPES_ENUM['scissor']].card_sprite):
